...
- [13. カスケードシャドウ](#13-カスケードシャドウ)
  - [13.1. アルゴリズムの流れ](#131-アルゴリズムの流れ)
  - [13.2. 影を描画する](#132-影を描画する)
...
### 13.1.2. 分割エリアを描画するためのライトビュープロジェクション行列の計算
...
#### 13.1.2.1. 通常のデプスシャドウマップ技法用のライトビュープロジェクション行列を作成する
...
#### 13.1.2.2. 分割エリアの定義に従って、各エリアを内包する視錐台の8頂点を求める
...
#### 13.1.2.3. 各エリアの8頂点をライトビュープロジェクション空間に変換する
...
#### 13.1.2.4. 8頂点の最大値と最小値を利用して、ライトビュープロジェクション空間に収めるクロップ行列を計算する
