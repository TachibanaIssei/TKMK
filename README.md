...
## 拡散反射光
今回実装した拡散反射はフレネル反射を考慮したものです。その考え方について説明していきます。<br>
...
このフレネル反射が弱いということは、「物体内部に侵入する光が多くなるため、内部で拡散する拡散反射が強くなる」ということになります。また、最も拡散反射が強くなるのは、光がサーフェイスに垂直に入射しているときです。<br>
次に、カメラの位置(視点)についてです。拡散反射がより強く目に飛び込んでくるのは「サーフェイスから目までのベクトルと、光の入射ベクトルがなす角度が小さいとき」です。つまり、拡散反射は「ひかりの入射ベクトルとサーフェイスの法線、そして目までのベクトルが近いほど強い」といえます。<br>
